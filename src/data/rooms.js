export const rooms = [
  {
    ...
    description: "Phòng học cao cấp với 2 máy lạnh, đầy đủ tiện nghi hiện đại, phù hợp cho các khóa học chất lượng cao",
    price: 90000,
    capacity: 20,
    airConditioners: 2,
    amenities: ["2 máy lạnh", "Máy chiếu", "Bảng thông minh", "WiFi", "Ghế êm", "Bàn học cá nhân"],
    images: [
  ...
  },
  {
    ...
    description: "Phòng học với 1 máy lạnh và không gian thoải mái, phù hợp cho các lớp học thường",
    price: 70000,
    capacity: 15,
    airConditioners: 1,
  ...
  },
  {
    ...
    description: "Phòng học ấm cúng với 1 máy lạnh cho nhóm nhỏ, tạo không gian học tập thân thiện",
    price: 70000,
    capacity: 8,
    airConditioners: 1,
  ...
  },
  {
    ...
    description: "Phòng học được trang bị công nghệ hiện đại với 2 máy lạnh, phù hợp cho các khóa học IT",
    price: 90000,
    capacity: 12,
    airConditioners: 2,
    amenities: ["2 máy lạnh", "Máy tính", "Máy chiếu 4K", "Bảng thông minh", "WiFi tốc độ cao", "Ghế gaming"],
    images: [
  ...
  },
  {
    ...
    description: "Không gian yên tĩnh với 1 máy lạnh và ánh sáng tự nhiên, lý tưởng cho việc tự học",
    price: 70000,
    capacity: 6,
    airConditioners: 1,
    amenities: ["1 máy lạnh", "Ánh sáng tự nhiên", "WiFi", "Ghế đọc sách", "Kệ sách"],
    images: [
  ...
  },
  {
    ...
    description: "Phòng học lớn với 2 máy lạnh, phù hợp cho thuyết trình và hội nghị",
    price: 90000,
    capacity: 50,
    airConditioners: 2,
